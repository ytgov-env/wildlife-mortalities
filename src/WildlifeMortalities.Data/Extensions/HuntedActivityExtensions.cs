...
public static class HuntedActivityExtensions
{
    ...
    public static CaribouHerd? GetLegalHerd(this HuntedActivity activity, DateTimeOffset date)
    {
        if (s_simpleHerdMapper.TryGetValue(activity.GameManagementArea.Area, out var herd))
        {
            return herd;
        }

        if (
            s_complexHerdMapper.TryGetValue(
                activity.GameManagementArea.Area,
                out var herdTimeMapper
            )
        )
        {
