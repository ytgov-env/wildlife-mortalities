...
public class HuntingPermit : Authorization
{
    ...
    public bool IsCaribouRelated() => Type is
        PermitType.CaribouFortymileFall or
        PermitType.CaribouFortymileSummerPeriodOne or
        PermitType.CaribouFortymileSummerPeriodTwo or
        PermitType.CaribouFortymileSummerPeriodThree or
        PermitType.CaribouFortymileSummerPeriodFour or
        PermitType.CaribouFortymileSummerPeriodFive or
        PermitType.CaribouFortymileSummerPeriodSix or
        PermitType.CaribouFortymileSummerPeriodSeven or
        PermitType.CaribouFortymileSummerPeriodEight or
        PermitType.CaribouFortymileWinter or
        PermitType.CaribouHartRiver or
        PermitType.CaribouNelchina;
