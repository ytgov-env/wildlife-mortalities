...
namespace WildlifeMortalities.Data.Migrations
{
    ...
    [Migration("20230706181936_AddEyeSocketBooleanForSheep")]
    partial class AddEyeSocketBooleanForSheep
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WildlifeMortalities.Data.Entities.Violation", b =>
                {
                    ...
                    b.ToTable("Violations", t =>
                        {
                            t.HasCheckConstraint("CK_Violations_Rule_Enum", "[Rule] IN (10, 20, 100, 101, 102, 103, 200, 201, 202, 300, 301)");
                    ...
                    b.ToTable("BagLimitEntries", null, t =>
                        {
                            ...
                            t.Property("SeasonId")
                                .HasColumnName("TrappingBagLimitEntry_SeasonId");
                        });
            ...
            modelBuilder.Entity("WildlifeMortalities.Data.Entities.Reports.SingleMortality.TrappedActivity", b =>
                {
                    ...
                    b.ToTable("Activities", null, t =>
                        {
                            t.HasCheckConstraint("CK_Activities_HarvestMethod_Enum", "[HarvestMethod] IN (10, 20, 30, 40)");
                        });
            ...
            modelBuilder.Entity("WildlifeMortalities.Data.Entities.RegisteredTrappingConcession", b =>
                {
                    b.HasOne("WildlifeMortalities.Data.Entities.Rules.BagLimit.TrappingBagLimitEntry", null)
                        .WithMany("RegisteredTrappingConcessions")
