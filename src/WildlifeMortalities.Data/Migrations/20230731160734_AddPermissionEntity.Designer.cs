...
namespace WildlifeMortalities.Data.Migrations
{
    ...
    [Migration("20230731160734_AddPermissionEntity")]
            ...
            modelBuilder.Entity("WildlifeMortalities.Data.Entities.Violation", b =>
                {
                    ...
                    b.ToTable("Violations", t =>
                        {
                            t.HasCheckConstraint("CK_Violations_Rule_Enum", "[Rule] IN (10, 20, 30, 100, 110, 120, 130, 200, 210, 220, 230, 240, 300, 310, 400)");
            ...
            modelBuilder.Entity("WildlifeMortalities.Data.Entities.Reports.SingleMortality.HarvestActivity", b =>
                {
                    ...
                    b.HasIndex("HrbsNumber")
                        .IsUnique()
                        .HasFilter("[HarvestActivity_HrbsNumber] IS NOT NULL");
