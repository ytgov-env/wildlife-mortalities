...
namespace WildlifeMortalities.Data.Migrations
{
    ...
    [Migration("20230719015439_FixSelfReferencingRelationshipForBagLimitEntry")]
    partial class FixSelfReferencingRelationshipForBagLimitEntry
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WildlifeMortalities.Data.Entities.Violation", b =>
                {
                    ...
                    b.ToTable("Violations", t =>
                        {
                            t.HasCheckConstraint("CK_Violations_Rule_Enum", "[Rule] IN (10, 20, 100, 110, 120, 130, 200, 210, 220, 230, 300, 310, 400)");
