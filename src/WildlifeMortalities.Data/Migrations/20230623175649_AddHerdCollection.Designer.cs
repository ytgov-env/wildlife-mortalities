...
namespace WildlifeMortalities.Data.Migrations
{
    ...
    [Migration("20230623175649_AddHerdCollection")]
    partial class AddHerdCollection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WildlifeMortalities.Data.Entities.Violation", b =>
                {
                    ...
                    b.ToTable("Violations", t =>
                        {
                            t.HasCheckConstraint("CK_Violations_Rule_Enum", "[Rule] IN (10, 20, 30)");
