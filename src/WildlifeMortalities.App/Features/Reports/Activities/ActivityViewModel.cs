...
{
    protected int _id = Constants.EfCore.TemporaryAutoGeneratedKey;
    ...
    public void ResetSpecies(Species species)
    {
        _id = Constants.EfCore.TemporaryAutoGeneratedKey;
        MortalityWithSpeciesSelectionViewModel = new MortalityWithSpeciesSelectionViewModel
        {
            Species = species,
            MortalityViewModel = MortalityViewModel.Create(
                species,
                MortalityWithSpeciesSelectionViewModel!.MortalityViewModel
            )
        };
    }
