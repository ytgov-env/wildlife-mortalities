...
internal static class AreaSeeder
{
    internal static void AddAllRegisteredTrappingConcessions(AppDbContext context)
    {
    ...
    internal static void AddAllGameManagementAreas(AppDbContext context)
    {
    ...
    internal static void AddAllOutfitterAreas(AppDbContext context)
    {
